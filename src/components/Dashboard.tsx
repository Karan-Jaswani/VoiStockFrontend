    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer" onClick={() => handleNavigation('/show-invoices')}>
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer" onClick={() => handleNavigation('/show-delivery-challans')}>
                    <h2 className="text-xl font-semibold">View Delivery Challans</h2>
                    <p className="mt-2 text-gray-600">View delivery challans history for your shipments.</p>
                </div>
